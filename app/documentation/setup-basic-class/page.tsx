...
export default function Page() {
  return (
    <div className="flex flex-col gap-6">
      <h1 className="font-title text-xl md:text-4xl">Setup Basic Class</h1>
      <p>
        ...
        <a href="#step-2" className={linkClasses}>
          skip step 1
        </a>{' '}
        as the class values would have already been set. For this example, I will be creating my
        first ever coding class, CMSC131 - Object Orientated Programming I.
      </p>
      <section id="step-1" className="flex flex-col gap-4">
        <h2 className="text-lg md:text-2xl">Step 1: Configure Class</h2>
        <p>
          For this tutorial we will start out with a blank guest class as shown below. If you are
          not using a guest class you can{' '}
          <a href="#step-2" className={linkClasses}>
            skip this step
          </a>
          .
        ...
        <p>
          ...
          <Link href="/documentation/customization" className={linkClasses}>
            Customization Page
          </Link>{' '}
          to see more information about how you can customize your class. This is what the dialog
          looks like once I&apos;ve added the information above.
        </p>
        <Image
      ...
      <section id="step-2" className="flex flex-col gap-4">
        <h2 className="text-lg md:text-2xl">Step 2: Add Assignment Type(s)</h2>
        <p>
          ...
          <Link href="/documentation/import-export" className={linkClasses}>
            Import/Export
          </Link>{' '}
          feature or the{' '}
          <Link className={linkClasses} href="/documenation/syllabus-scanning">
            Scan Syllabus
          </Link>{' '}
          feature. For this example we are gonna keep it simple and do it manually.
        </p>
        <p>
        ...
        <p>
          ...
          the{' '}
          <Link className={linkClasses} href="/documenation/weight-locking">
            Weight Locking
          </Link>{' '}
          Page. For this tutorial, we will simply explain it as, some assignment types are given a
          weight and the assignments within that assignment type all have the same weight. For
          example, quizzes are worth 20% and there will be 6 quizzes. Instead of having to do 20 / 6
          manually, you can the quizzes weights and enter 20%. Then when you add the 6 quizzes,
          GradeMaster will balance the weights for you!
        </p>
        <p>
      ...
      <section id="step-3" className="flex flex-col gap-4">
        <h2 className="text-lg md:text-2xl">Step 3: Add Assignments</h2>
        <p>
        ...
        <p>
          ...
          values in depth in the{' '}
          <Link href="/documentation/dynamic-updates" className={linkClasses}>
            Dynamic Updates
          </Link>{' '}
      ...
      <section id="step-4" className="flex flex-col gap-4">
        <h2 className="text-lg md:text-2xl">Step 4: Use However You&apos;d Like!</h2>
        <p>
