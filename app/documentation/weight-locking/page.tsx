    ...
    <div className="documentation-page">
      ...
      <section>
        ...
        <p>
          ...
          and is pretty manageable. But what if we get to week 3 and we don&apos;t have any
          homework. Now all my formulas are messed up and I have to change all of them, or change
          one and copy it over to the rest. This is something that would happen to me a lot. So when
      ...
      <section>
        ...
        <p>
          ...
          my homeworks assignment type. I didn&apos;t have to do any calculations and GradeMaster
          set each weight to 5 / 15 = .33. But once I got to week 3 and there was no homework, if I
          assume that the pattern still holds up but I we just didn&apos;t have one this week, I
          simply have to delete one of the assignments. Now all 14 of the other assignments are
          updated to 5 / 14 = .36 instantly!
        </p>
      </section>
    </div>
  );
